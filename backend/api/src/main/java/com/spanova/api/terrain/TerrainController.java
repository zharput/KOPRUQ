...
import com.spanova.terrain.TerrainImportService;
 ...
 * {@code com.spanova.terrain}'s package javadoc for the domain-layer
 ...
 * writes into (see {@code com.spanova.api.config.SharedRepositoriesConfig}).
 */
@RestController
...
public class TerrainController {
    ...
    private static double[] localPositions(java.util.List<com.spanova.spatialcore.Point3D> points, TerrainModel terrain) {
