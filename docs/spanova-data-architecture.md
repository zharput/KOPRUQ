# SPANOVA Data Architecture (Phase 2E)
...
|---|---|---|
| Pier | `spanova.project-design-system.pier-families` | Repository-backed; stable IDs retained. |
| Pier Cap | `spanova.project-design-system.pier-cap-families` | Repository-backed; stable IDs retained. |
| Foundation | `spanova.project-design-system.foundation-families` | Repository-backed; stable IDs and domain-derived piled geometry retained. |
| Bearing | `spanova.project-design-system.bearing-families` | Repository-backed; stable IDs retained. |
| Girder | `spanova.girder-library.precast` | Existing dimension record and generated variant IDs remain. Not yet a stable family catalog; adapter migration is future work. |
...
| Material | `spanova.project-design-system.material-assignments` | Concrete class per structural element, not a material-property family catalog. No material properties or IDs invented. |
