 ...
 * detail (used only inside {@link com.kopruq.terrain.TerrainImportService})
 * - not exposed anywhere in this package's public API, matching
 * {@code bridge-core}'s framework-independence discipline. Depends
 * only on {@code spatial-core} for {@link com.kopruq.spatialcore.Point3D}/
 * {@link com.kopruq.spatialcore.CoordinateSystem}.
 */
