...
export type GraphValue = number | boolean | string | number[] | EngineeringQuantity | EngineeringQuantity[] | MaterialValue | PierCandidate | PierCandidate[] | PierCapCandidate | PierCapCandidate[] | FoundationCandidate | FoundationCandidate[] | BearingCandidate | BearingCandidate[]
