...
export function canConnect(source:GraphPortType,target:GraphPortType,sourceKind?:QuantityKind,targetKind?:QuantityKind){
  ...
  if(requiredKind){
    ...
    if(numericSource)return sourceKind===requiredKind
