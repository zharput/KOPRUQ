...
const CATALOG_KEYS = {
  preferred: 'kopruq.project-design-system.girder-span-rules',
}
...
export default function BridgeDefinitionWorkspace({ bridges, project, store, setStore, terrainId, landXmlImportId, setTerrainId, setLandXmlImportId }: Props) {
  ...
  useEffect(() => {
    ...
    const events = ['storage', 'kopruq:pier-catalog-changed', 'kopruq:pier-cap-catalog-changed', 'kopruq:foundation-catalog-changed', 'kopruq:bearing-catalog-changed']
