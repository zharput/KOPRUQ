...
import com.spanova.analysisengine.SpanovaAnalysisEngine;
 ...
 * {@link SpanovaAnalysisEngine} and returns reactions/displacements as a
...
public class FastSolverController {
    ...
    private final SpanovaAnalysisEngine engine = new SpanovaAnalysisEngine();
    ...
    private static double totalAppliedLoad(FastSolverModel model) {
        ...
        for (AnalysisElement element : request.elements()) {
            ...
            if (hasSelfWeight) {
                ...
                double area = section instanceof com.spanova.analysis.SolidRectangleSection rect
