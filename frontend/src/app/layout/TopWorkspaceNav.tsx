...
export default function TopWorkspaceNav() {
  ...
  return <header className="spn-workspace-nav" aria-label="Primary workspaces">
    <Link to="/project" className="spn-workspace-brand" aria-label="SPANOVA Project Overview"><span className="spn-workspace-brand-mark">S</span><span>SPANOVA</span></Link>
