...
public record LandXmlImportSummaryResponse(
        ...
        boolean hasProfile,
        List<String> warnings, String status, com.kopruq.terrain.TerrainSource source,
        com.kopruq.spatialcore.Point3D boundsMin, com.kopruq.spatialcore.Point3D boundsMax,
