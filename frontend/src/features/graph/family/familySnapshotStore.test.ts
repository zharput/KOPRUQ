...
const graph: SpanovaGraph = { id: 'graph-1', bridgeId: 'bridge-1', name: 'Graph', schemaVersion: 1, nodes: [{ id: 'node-1', type: 'substructure.pier.rectangular', name: 'Pier', position: { x: 0, y: 0 }, parameters: {} }], connections: [] }
