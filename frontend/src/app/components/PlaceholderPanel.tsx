...
const MILESTONE_BY_SECTION: Partial<Record<SectionId, string>> = {
  ...
  'bearing-families': 'elastomeric bearings via externally-supplied Kx/Ky/Kz are agreed (P07) and used in the KOPRUQ Fast Solver - not modelled as a reusable library yet',
  ...
  'bridge-bearings': 'bearing stiffness (Kx/Ky/Kz/Krx/Kry/Krz) is entered directly on the KOPRUQ Fast Solver form for now',
  'bridge-foundations': 'only pile count/diameter are modelled in bridge-core today',
  'model-reduction': 'not started',
  'analysis-queue': 'not started - KOPRUQ Fast Solver runs synchronously to completion today, nothing to queue yet',
